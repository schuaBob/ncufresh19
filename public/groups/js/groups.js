...
$(document).ready(function() { //顯示或更換顯示學院
    ...
    $(".snap_btn").on("click", function() {
        ...
        $(".title").fadeOut(4000)
        setTimeout(function() { $(".line").fadeOut(4000) }, 1000)
        setTimeout(function() { $("[class='nava a']").fadeOut(5000) }, 1000)
        setTimeout(function() { $("[class='sideli 5']").fadeOut(5000) }, 1000)
        setTimeout(function() { $("[class='nava b']").fadeOut(5000) }, 2000)
        setTimeout(function() { $("[class='sideli 3']").fadeOut(5000) }, 2000)
        setTimeout(function() { $("[class='sideli 2']").fadeOut(5000) }, 2000)
        setTimeout(function() { $("[class='sideli 7']").fadeOut(5000) }, 3000)
        setTimeout(function() { $("[class='nava d']").fadeOut(5000) }, 3000)
        setTimeout(function() { $("[class='sideli 8']").fadeOut(5000) }, 4000)
        setTimeout(function() { $("[class='nava c']").fadeOut(5000) }, 4000)
        setTimeout(function() { $("[class='sideli 1']").fadeOut(5000) }, 5000)
        setTimeout(function() { $("[class='nava e']").fadeOut(5000) }, 5000)
        setTimeout(function() { $("[class='sideli 4']").fadeOut(5000) }, 5000)
        setTimeout(function() { $("[class='sideli 6']").fadeOut(5000) }, 5000)
        setTimeout(function() { $(".navbar").fadeOut(5000) }, 6000)
        setTimeout(function() { $(".buttons").fadeOut(5000) }, 6000)
        setTimeout(function() { $(".sidebar2").fadeOut(5000) }, 7000)
        setTimeout(function() { $(".linkbuttons").fadeOut(5000) }, 7000)
        setTimeout(function() { $(".de-en").fadeOut(5000) }, 7000)
        setTimeout(function() { $(".de-info").fadeOut(5000) }, 8000)
        setTimeout(function() { $(".title_bar").fadeOut(5000) }, 8000)
        setTimeout(function() {

            $("#snap").css("height", "80vh")
            $("#sign").css("width", "40vw")
